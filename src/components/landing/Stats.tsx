...
const Stats = () => {
  return (
    <section className="py-16 bg-hero border-y" style={{ borderColor: "hsl(0 0% 10%)" }}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto">
          {stats.map((stat, i) => (
            ...
            >
              ...
              <div className="text-xs font-mono uppercase tracking-wider mt-2" style={{ color: "hsl(0 0% 45%)" }}>
                {stat.label}
              </div>
            </motion.div>
          ))}
