...
export async function exportToPptx(markdown: string, filename = "report") {
  ...
  titleSlide.addShape(pres.ShapeType.rect, { x: 0, y: 1.5, w: "100%", h: 3, fill: { color: "EA7915" } });
  ...
  titleSlide.addText("Generated by DataAfro AI", { x: 1, y: 3.5, w: 11, h: 0.8, color: "FFF3E0", fontSize: 16, fontFace: "Arial" });
